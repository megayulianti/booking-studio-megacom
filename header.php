            ...
            <div class="container">
                <div class="pull-left">
                    ...
                    <div class="header-logo">
                        <a class="logo" href="#">
                            <img src="frontend/img/logo2.jpg" alt="">
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <ul class="header-btns">
                        ...
                        <li class="header-cart dropdown default-dropdown">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <strong class="text-uppercase">BOOKING :</strong>
                                <br>
                                <?php
                                $total = 0;
                            ...
                            <div class="custom-menu">
                                <div id="shopping-cart">
                                        ...
                                        ?>
                                                    <div class="product product-widget">
                                                        <div class="product-thumb">
                                                            <img src="<?php echo $i['layanan_foto1'] ? "gambar/layanan/{$i['layanan_foto1']}" : 'gambar/sistem/layanan.png'; ?>" alt="">
                                                        </div>
                                                        <div class="product-body">
                                                            <h3 class="product-price"><?php echo "Rp. " . number_format($i['layanan_harga']) . " ,-"; ?></h3>
                                                            <h2 class="product-name"><a href="layanan_detail.php?id=<?php echo $i['layanan_id'] ?>"><?php echo $i['layanan_nama'] ?></a></h2>
                                                        </div>
                                                        <a class="cancel-btn" href="keranjang_hapus.php?id=<?php echo $i['layanan_id']; ?>&redirect=keranjang"><i class="fa fa-trash"></i></a>
                                                    </div>
                                        <?php
                                                }
                                            } else {
                                                echo "<center>layanan Masih Kosong.</center>";
                                            }
                                        } else {
                                            echo "<center>layanan Masih Kosong.</center>";
                                        }
                                    ...
                                    <div class="shopping-cart-btns">
                                        ...
                                        <a class="primary-btn" href="checkout.php">Booking <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        ?>
                            ...
                            <li class="header-account dropdown default-dropdown" style="min-width: 200px">
                                ...
                                <ul class="custom-menu">
                                    ...
                                    <li><a href="customer_booking.php"><i class="fa fa-list"></i> Booking Saya</a></li>
        ...
        <div class="container">
            <div id="responsive-nav">
                ...
                <div class="category-nav show-on-click">
                    <span class="category-header">Kategori Layanan <i class="fa fa-list"></i></span>
                    <ul class="category-list">
                        <?php
                        $data = mysqli_query($koneksi, "SELECT * FROM kategori");
                        while ($d = mysqli_fetch_array($data)) {
                        ?>
                            <li><a href="layanan_kategori.php?id=<?php echo $d['kategori_id']; ?>"><?php echo $d['kategori_nama']; ?></a></li>
                        <?php
                        }
                        ?>
                ...
                <div class="menu-nav">
                    ...
                    <ul class="menu-list">
                        ...
                        <li><a href="halaman_pelanggan.php">Layanan</a></li>
                    </ul>
                </div>
                <!-- /menu nav -->
            </div>
