...
<head>
  ...
  <title>Dashboard Admin - megacom studio</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>Megacom Studio</span>
        <span class="logo-lg"><b>Megacom Studio</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <?php } ?>
                <span class="hidden-xs"><?php echo $_SESSION['nama']; ?> - Pemilik</span>
              </a>
            </li>
            <li>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="pemilik.php">
              <i class="fa fa-user"></i> <span>DATA PEMILIK</span>
            </a>
          </li>

          <li>
            <a href="laporan_kategori.php">
              <i class="fa fa-file"></i> <span>LAPORAN KATEGORI</span>
            </a>
          </li> 

          <li>
            <a href="laporan_customer.php">
              <i class="fa fa-file"></i> <span>LAPORAN CUSTOMER</span>
            </a>
          </li> 
