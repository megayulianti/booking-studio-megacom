                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        if($i['invoice_status'] == 0){
                          ...
                          echo "<span class='label label-primary'>foto bisa diambil </span>";
                      ...
                      <td class="text-center">
                        <form action="transaksi_status.php" method="post">
                          ...
                          <select name="status" id="" class="form-control" onchange="form.submit()">
                            ...
                            <option <?php if($i['invoice_status'] == "2"){echo "selected='selected'";} ?> value="2">konfirmasi diproses</option>
                            <option <?php if($i['invoice_status'] == "2"){echo "selected='selected'";} ?> value="3">ditolak</option>
                            <option <?php if($i['invoice_status'] == "3"){echo "selected='selected'";} ?> value="4">foto bisa diambil sekarang</option>
                            <option <?php if($i['invoice_status'] == "4"){echo "selected='selected'";} ?> value="5">Selesai</option>
